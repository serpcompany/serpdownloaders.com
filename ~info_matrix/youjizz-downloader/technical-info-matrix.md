# Technical Info Matrix — YouJizz Downloader
...
| Field | Value |
|---|---|
| **Extension Name** | Video Downloader for YouJizz |
| **Slug / ID** | `youjizz-downloader` |
| **Gecko ID** | `youjizz-downloader@serpapps.com` |
| **Category** | Video Downloader (Adult) |
| **Target Site(s)** | youjizz.com and subdomains |
| **Description** | Download YouJizz videos |
...
| **Manifest Spec** | MV3 |
| **Branch Name** | `legacy/youjizz-downloader` |
| **Last Updated** | 2026-03-06 |
| **Build Date** | 2026-03-04T17:38:46.821Z |
...
| **Store-Sanitized Build?** | Yes (`youjizz-downloader-chrome-store-sanitized.zip`) |
| **GitHub Releases Repo** | `serpapps/youjizz-downloader` |
| **Product Page** | https://serp.ly/youjizz-downloader |
...
| **Context Menu** | Yes — "Download YouJizz Video" on page and video contexts |
| **Auto-Save** | Yes — saves to `Downloads/YouJizz/` folder, no save-as dialog |
| **Desktop Notifications** | Yes — "YouJizz Download Complete" |
...
| **Host Permissions** | `https://api.github.com/*`, `https://auth.serp.co/*`, `https://youjizz.com/*`, `https://*.youjizz.com/*` |
| **Content Scripts** | `site-config.js` → `logger.js` → `download-manager.js` → `content.js` → `player-button.js` — injected on `youjizz.com` at `document_idle` |
...
|---|---|
| **Site Match** | `https://youjizz.com/*`, `https://*.youjizz.com/*` |
...
| **Format Sources** | A) flashvars_* mediaDefinitions, B) HTML5 `<video>`/`<source>`, C) Script regex for mp4/m3u8 URLs, D) `/video/get_media` API endpoint |
| **Script URL Regex** | `/https?:\\?\\/\\?\\/[^"'\\\s]+?\\.(?:m3u8\|mp4)(?:\\?[^"'\\\s]*)?/gi` |
| **CDN Detection** | Performance entries matching YouJizz CDN domains |
| **Media Request Patterns** | `/video/get_media`, `mediaDefinitions`, `.m3u8`, `.mp4`, `media=hls` |
...
| **Referer** | `https://youjizz.com/` |
| **User-Agent** | `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36...` |
| **Origin** | `https://youjizz.com` |
...
| **Panel ID** | `youjizz-download-manager` |
| **Card Width** | 380px |
...
| Field | Value |
|---|---|
| **Menu ID** | `download-youjizz-video` |
| **Title** | "Download YouJizz Video" |
| **Contexts** | `["page", "video"]` |
| **URL Patterns** | `youjizz.com/*` and subdomains |
...
| **Watermarked?** | Yes |
| **GitHub Release?** | Yes — `serpapps/youjizz-downloader` |
| **Has Worktree?** | Yes — `.worktrees/youjizz-downloader/` |

#### Platform Builds

| Platform | File | Size |
|---|---|---|
| Standard | `youjizz-downloader.zip` | 1.23 MB |
| Chrome | `youjizz-downloader-chrome.zip` | 1.15 MB |
| Chrome Store Sanitized | `youjizz-downloader-chrome-store-sanitized.zip` | 1.15 MB |
| Brave | `youjizz-downloader-brave.zip` | 1.15 MB |
| Edge | `youjizz-downloader-edge.zip` | 1.15 MB |
| Opera | `youjizz-downloader-opera.zip` | 1.15 MB |
| Whale | `youjizz-downloader-whale.zip` | 1.15 MB |
| Yandex | `youjizz-downloader-yandex.zip` | 1.15 MB |
| Firefox ZIP | `youjizz-downloader-firefox.zip` | 1.16 MB |
| Firefox XPI | `youjizz-downloader-firefox-unpacked.xpi` | 1.15 MB |
...
| **Stripe Product ID** | `prod_TfxYlIvcUSu9Li` |
| **Stripe Product Name** | YouJizz Downloader |
| **Stripe Monthly Price** | USD 9.00/month [youjizz-downloader monthly] |
| **Stripe One-Time Price** | USD 17.00/one_time |
| **Stripe Price IDs** | `price_1SibdnDP7AOTRcvm60ps6Xm3`, `price_1SymtFDP7AOTRcvm9efaOPqE` |
