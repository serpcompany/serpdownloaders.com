# Technical Info Matrix — YesPornPlease Downloader
...
| Field | Value |
|---|---|
| **Extension Name** | Video Downloader for YesPornPlease |
| **Slug / ID** | `yespornplease-downloader` |
| **Gecko ID** | `yespornplease-downloader@serpapps.com` |
| **Category** | Video Downloader (Adult) |
| **Target Site(s)** | yespornplease.com and subdomains |
| **Description** | Download YesPornPlease videos |
...
| **Manifest Spec** | MV3 |
| **Branch Name** | `legacy/yespornplease-downloader` |
| **Last Updated** | 2026-03-05 |
| **Build Date** | 2026-03-04T17:38:21.873Z |
...
| **Store-Sanitized Build?** | Yes (`yespornplease-downloader-chrome-store-sanitized.zip`) |
| **GitHub Releases Repo** | `serpapps/yespornplease-downloader` |
| **Product Page** | https://serp.ly/yespornplease-downloader |
...
| **Context Menu** | Yes — "Download YesPornPlease Video" on page and video contexts |
| **Auto-Save** | Yes — saves to `Downloads/YesPornPlease/` folder, no save-as dialog |
| **Desktop Notifications** | Yes — "YesPornPlease Download Complete" |
...
| **Host Permissions** | `https://api.github.com/*`, `https://auth.serp.co/*`, `https://yespornplease.com/*`, `https://*.yespornplease.com/*` |
| **Content Scripts** | `site-config.js` → `logger.js` → `download-manager.js` → `content.js` → `player-button.js` — injected on `yespornplease.com` at `document_idle` |
...
| Bootstrap | `bootstrap.js` | Extension bootstrap loader |

### Video Detection & Extraction

| Feature | Implementation |
|---|---|
| **Site Match** | `https://yespornplease.com/*`, `https://*.yespornplease.com/*` |
...
| **Duration Sources** | `<video>` element, `flashvars.video_duration`, `flashvars.videoDuration`, ISO 8601, `meta[property="video:duration"]` |
...
| **CDN Detection** | Performance entries matching `/cdn\\.yespornplease\\.com/i` |
...
| **Referer** | `https://yespornplease.com/` |
| **User-Agent** | `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36...` |
| **Origin** | `https://yespornplease.com` |
...
| **Panel ID** | `yespornplease-download-manager` |
| **Card Width** | 380px |
...
| Field | Value |
|---|---|
| **Menu ID** | `download-yespornplease-video` |
| **Title** | "Download YesPornPlease Video" |
| **Contexts** | `["page", "video"]` |
| **URL Patterns** | `yespornplease.com/*` and subdomains |

### Popup UI

| Property | Value |
|---|---|
| **Stylesheets** | `styles/styles.css` (8.8 KB), `styles/popup-enhanced.css` (8.0 KB) |
...
| **Watermarked?** | Yes |
| **GitHub Release?** | Yes — `serpapps/yespornplease-downloader` |
| **Has Worktree?** | Yes — `.worktrees/yespornplease-downloader/` |

#### Platform Builds

| Platform | File | Size |
|---|---|---|
| Standard | `yespornplease-downloader.zip` | 1.24 MB |
| Chrome | `yespornplease-downloader-chrome.zip` | 1.15 MB |
| Chrome Store Sanitized | `yespornplease-downloader-chrome-store-sanitized.zip` | 1.15 MB |
| Brave | `yespornplease-downloader-brave.zip` | 1.15 MB |
| Edge | `yespornplease-downloader-edge.zip` | 1.15 MB |
| Opera | `yespornplease-downloader-opera.zip` | 1.15 MB |
| Whale | `yespornplease-downloader-whale.zip` | 1.15 MB |
| Yandex | `yespornplease-downloader-yandex.zip` | 1.15 MB |
| Firefox ZIP | `yespornplease-downloader-firefox.zip` | 1.16 MB |
| Firefox XPI | `yespornplease-downloader-firefox-unpacked.xpi` | 1.15 MB |
...
| **Stripe Product ID** | `prod_TfxYsrMoiwyx5d` |
| **Stripe Product Name** | Yespornplease Downloader |
| **Stripe Monthly Price** | USD 9.00/month [yespornplease-downloader monthly] |
| **Stripe One-Time Price** | USD 17.00/one_time |
| **Stripe Price IDs** | `price_1SibdmDP7AOTRcvm2CfmuNYO`, `price_1SymtEDP7AOTRcvmESxd9cu2` |
